...
const DataPage: React.FC<IDataPage> = () => {
  return (
    <div className={styles.dataPageLayout}>
      <div className={styles.dataPageContainer}>
            ...
            <div className={styles.divBorderCorner}>
              <div className={styles.divBorderCornerInner}>
                ...
                <p className={styles.section2P}>
                  As more <span className={styles.bold}>satellites</span> are
                  launched into <span className={styles.bold}>orbit</span> in
                  the coming decades, the number of{" "}
                  <span className={styles.bold}>collisions</span> and subsequent{" "}
        ...
        <div className={styles.section3}>
          ...
          >
            ...
            <p className={styles.infoCard2p}>
              ...
              <img src={asteriskIcon} alt="" className={styles.asteriskIcon} />
            </p>
          </div>
          <div
            className={styles.infoCard}
          ...
          >
            <p className={styles.infoCard1p}>
              Number of debris objects estimated by statistical models to be in
              orbit
            </p>
            <p className={styles.infoCard2p}>
              <span className={styles.bold}>36 500 objects</span> greater than
              10 cm <span className={styles.bold}>1 000 000 objects</span> from
          ...
          >
            <p className={styles.infoCard1p}>
              Number of satellites these rocket launches have placed into Earth
              orbit
            </p>
            <p className={styles.infoCard2p}>
          ...
          >
            <p className={styles.infoCard1p}>
              Number of debris objects regularly tracked by Space Surveillance
              Networks and maintained in their catalogue
            </p>
            <p className={styles.infoCard2p}>
        ...
        <div className={styles.section4}>
          <div className={styles.divCornerCont2}>
            ...
            <div className={styles.divBorderCorner}>
              <div className={styles.divBorderCornerInner}>
                <h2>
                  Russian missile creates space debris threatening ISS and other
                  satellites
                </h2>
                <p className={[styles.section2P, styles.mb120].join(" ")}>
                  Early this week,{" "}
                  <span className={styles.bold}>Russia launched a missile</span>{" "}
                  that destroyed the country’s Kosmos 1408 satellite, a large
                  spacecraft that orbited the Earth roughly{" "}
                  <span className={styles.bold}>300 miles up</span>. The breakup
                  of the satellite created at least 1,500 pieces of trackable
                  fragments, according to the US State Department, as well as{" "}
                  <span className={styles.bold}>
                    thousands of smaller pieces
                  </span>{" "}
                  that cannot be tracked. All of those pieces are still in low
                  Earth orbit, moving{" "}
                  <span className={styles.bold}>
                    at thousands of miles an hour
                  </span>{" "}
                  and posing a threat to any objects that might cross their
                  path. Initially, that even included the International Space
                  Station, with crew members on board forced to take shelter in
                  their spacecrafts as{" "}
                  <span className={styles.bold}>
        ...
        <div className={styles.section5}>
          ...
          <div className={styles.roundedGraphicCont}>
            <img src={"/earthImg.png"} alt="" className={styles.earthImg} />
            <img
              src={roundedGraphic}
              alt=""
